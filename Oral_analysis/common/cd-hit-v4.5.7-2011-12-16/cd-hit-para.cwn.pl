...
##LD_LIBRARY_PATH="/usr/local/lib64/:/usr/local/lib/:/opt/gridengine/lib/lx26-amd64:/opt/gridengine/lib/lx26-amd64/"
##LD_LIBRARY_PATH="/opt/gridengine/lib/lx26-amd64:/opt/gridengine/lib/lx26-amd64:/usr/lib/oracle/11.1.0.1/client64/lib:/usr/local/lib:/usr/local/lib64:/usr/lib:/usr/lib64:/share/raid1/genome/soft/boost_1_38_0/lib:/share/raid1/genome/biosoft/atlas/lib"
##LD_LIBRARY_PATH="/opt/gridengine/lib/lx26-amd64:/opt/gridengine/lib/lx26-amd64:/usr/local/lib64:/usr/local/lib"
##LD_LIBRARY_PATH="/opt/gridengine/lib/lx26-amd64:/opt/gridengine/lib/lx26-amd64:/usr/lib/oracle/11.1.0.1/client64/lib:/usr/local/lib:/usr/local/lib64:/usr/lib:/usr/lib64:/share/raid1/genome/soft/boost_1_38_0/lib:/share/raid1/genome/biosoft/atlas/lib"
LD_LIBRARY_PATH="/opt/gridengine/lib/lx26-amd64:/opt/gridengine/lib/lx26-amd64:/usr/lib/oracle/11.1.0.1/client64/lib:/home/guanyl:/usr/local/lib:/usr/local/lib64:/usr/lib:/usr/lib64:/share/raid1/genome/soft/boost_1_38_0/lib:/share/raid1/genome/biosoft/atlas/lib"
##LD_LIBRARY_PATH="/home/guanyl"
...
#      die "$pwd\t$tsh\n";# rm 
            ...
            my $t = "para-$thost_idx";
            open(QUEUE,"| qsub -cwd -N $t -e $qsub_log/$i.log -o $qsub_log/$i.log -l vf=2G ");
            print QUEUE <<EOD;
cd $pwd
sh $tsh
...
sub write_restart {
    my ($i, $j, $k);
    open(RES, "> $restart_file.temp") || die;
    
    for ($i=0; $i<$command_no; $i++) {
        print RES "$commands[$i]\n$command_status[$i]\n";
    }
    close(RES);
    `mv -f $restart_file.temp $restart_file`;
}
########## END write_restart
