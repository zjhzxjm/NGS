...
perl $SoftDir/bin/filter.pl cag 700 > mgs
_SHELL_
close SHELL;
open QSUB,">$WorkDir/cag.qsub" or die $!;
print QSUB <<_QSUB_;
nohup /data_center_03/USER/zhongwd/bin/qsge --queue all.q,big.q --resource vf=5G:5G:25G:5G:5G:5G:5G:5G:5G:5G:5G:5G:5G:5G:5G:5G:5G:5G:5G:5G --maxjob 1 --jobprefix cag --lines 20 --reqsub --getmem $WorkDir/cag.sh &
_QSUB_
close QSUB;
system("sh $WorkDir/cag.qsub") if $autorun == 1;
